        ...
        <section className="section-policy">
          <div className="container">
            <ul className="policys">
              <li>
                <div className="flex">
                  <FontAwesomeIcon icon="fa-solid fa-jet-fighter-up icon" />
                  <div>
              ...
              <li>
                <div className="flex">
                  <FontAwesomeIcon icon="fa-solid fa-phone-flip icon" />
                  <div>
              ...
              <li>
                <div className="flex">
                  <FontAwesomeIcon icon="fa-solid fa-ship icon" />
                  <div>
              ...
              <li>
                <div className="flex">
                  <FontAwesomeIcon icon="fa-solid fa-credit-card icon" />
                  <div>
